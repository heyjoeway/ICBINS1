...
public class CharacterCamera : MonoBehaviour {
    ...
    public float hBorderDistance = 8F;
    public float hMoveMax = 16F;
    public float vMoveMaxGroundSlow = 6F;
    public float vMoveMaxGroundFast = 16F;
    public float vMoveMaxAir = 16F;
    public float vBorderDistanceAir = 32F;
